...
(function() {
  ...
  // Debug logging
  console.log('🔧 SW Debug: Service Worker support:', 'serviceWorker' in navigator);
  ...
  if ('serviceWorker' in navigator && (window.location.protocol === 'https:' || window.location.hostname === 'localhost')) {
    ...
    window.addEventListener('load', function() {
      ...
      navigator.serviceWorker.register('/sw-simple.js', { scope: '/' })
        .then(function(registration) {
          console.log('✅ Family Tree PWA: Service Worker registered successfully');
          console.log('🔧 SW Debug: Registration object:', registration);
          console.log('🔧 SW Debug: Registration scope:', registration.scope);
          console.log('🔧 SW Debug: Registration state:', registration.installing, registration.waiting, registration.active);
          
          // Check registration state changes
          if (registration.installing) {
            console.log('🔧 SW Debug: Service Worker installing...');
            registration.installing.addEventListener('statechange', function() {
              console.log('🔧 SW Debug: Installing state changed to:', this.state);
            });
          }
        ...
        .catch(function(error) {
          console.error('❌ Family Tree PWA: Service Worker registration failed:', error);
    ...
    console.log('❌ SW Debug: Service Worker not supported or wrong protocol/hostname');
  ...
  window.FamilyTreePWA = {
    ...
    refreshFamilyData: function() {
      ...
      if (!navigator.onLine) {
        ...
        if (confirm('You are offline. The app will reload but use cached data. Continue?')) {
          window.location.reload();
        }
        return;
      }
      ...
      if ('serviceWorker' in navigator && 'caches' in window) {
        caches.keys().then(cacheNames => {
          ...
          const familyDataCaches = cacheNames.filter(name => 
