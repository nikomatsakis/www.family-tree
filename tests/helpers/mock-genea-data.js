...
export function createMockPerson(genea, id, attributes = {}, relationships = {}) {
...
export function createMockPartnership(genea, id, parentIds = [], childIds = []) {
  return {
    id,
    type: 'partnership',
    attributes: {},
...
export function createMockFamily() {
  ...
  // Create parents
  people['p1'] = createMockPerson(null, 'p1', { 
    name: 'Dad Smith', 
    gender: 'male' 
  }, {
  ...
  people['p2'] = createMockPerson(null, 'p2', { 
    name: 'Aunt Smith', 
    gender: 'female' 
  }, {
    childIn: { data: { type: 'partnership', id: 'gp-partnership' } },
  ...
  people['p3'] = createMockPerson(null, 'p3', { 
    name: 'Mom Jones', 
    gender: 'female' 
  }, {
    parentIn: { data: [{ type: 'partnership', id: 'p-partnership' }] }
  ...
  people['uncle'] = createMockPerson(null, 'uncle', { 
    name: 'Uncle Bob', 
    gender: 'male' 
  }, {
    parentIn: { data: [{ type: 'partnership', id: 'aunt-partnership' }] }
  ...
  // Create children
  people['c1'] = createMockPerson(null, 'c1', { 
    name: 'Child One', 
    gender: 'male' 
  }, {
  ...
  people['c2'] = createMockPerson(null, 'c2', { 
    name: 'Child Two', 
    gender: 'female' 
  }, {
    childIn: { data: { type: 'partnership', id: 'p-partnership' } }
  ...
  // Create cousin
  people['cousin1'] = createMockPerson(null, 'cousin1', { 
    name: 'Cousin One', 
    gender: 'unknown' 
  }, {
  ...
  people['gp1'].relationships.parentIn.data = [{ type: 'partnership', id: 'gp-partnership' }];
  people['gp2'].relationships.parentIn.data = [{ type: 'partnership', id: 'gp-partnership' }];
...
export function createComplexMockFamily() {
  ...
  people['ggp1'].relationships.parentIn.data = [{ type: 'partnership', id: 'ggp-partnership' }];
  people['ggp2'].relationships.parentIn.data = [{ type: 'partnership', id: 'ggp-partnership' }];
  
  // Add second cousins branch
  people['gp3'] = createMockPerson(null, 'gp3', { 
  ...
  partnerships['ggp-partnership'].relationships.children.data.push({ type: 'person', id: 'gp3' });
  ...
  people['gp3'].relationships.parentIn.data = [{ type: 'partnership', id: 'gp3-partnership' }];
  people['gp4'].relationships.parentIn.data = [{ type: 'partnership', id: 'gp3-partnership' }];
  
  people['p4'] = createMockPerson(null, 'p4', { 
  ...
  people['cousin2'] = createMockPerson(null, 'cousin2', { 
    name: 'Second Cousin', 
    gender: 'female' 
  }, {
