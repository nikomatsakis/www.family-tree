...
class Path {
  ...
  #tryExtend(relation, person) {
    ...
    if (
      relation === 'partner' &&
      this.links.length > 0 &&
      this.links[this.links.length - 1].relation === 'partner'
    )
      return [];
...
console.log('Test 1: Sibling relationships');
{
  ...
  const parentPartnership = new Partnership(
    mockService,
    'parents',
    {},
    {
      ...
      children: {
        data: [
          { type: 'person', id: 'brother' },
          { type: 'person', id: 'sister' },
        ],
      },
    },
  );
  ...
  console.log(
    `  Brother's parents: ${brother.parents.map((p) => p.name).join(', ')}`,
  );
  console.log(
    `  Sister's parents: ${sister.parents.map((p) => p.name).join(', ')}`,
  );
  ...
  if (relationships.length > 0) {
    ...
    assertEqual(
      rel.name,
      'sister',
      'Brother to sister relationship should be "sister"',
    );
    ...
    assert(
      allSameRelationship,
      'All relationship paths should identify as "sister"',
    );
  }
}
...
console.log('\nTest 3: Self-relationship (edge case)');
{
  ...
  try {
    ...
    assertEqual(
      relationships.length,
      0,
      'Self-relationship should return empty array or handle gracefully',
    );
  } catch (e) {
...
console.log('\nTest 4: Half-siblings (share only one parent)');
{
  ...
  const partnership1 = new Partnership(
    mockService,
    'p1',
    {},
    {
  ...
  const partnership2 = new Partnership(
    mockService,
    'p2',
    {},
    {
  ...
  assert(
    ...
    'Half-siblings should have at least one relationship',
  );
...
console.log('\nTest 6: Step-siblings (no shared parents)');
{
  ...
  const partnership3 = new Partnership(
    mockService,
    'p3',
    {},
    {
...
console.log('\nTest 7: Missing partnership data');
{
  ...
  try {
    ...
    console.log(
      `  Orphan has ${parents.length} parents (should be 0 due to missing partnership)`,
    );
    assert(
      parents.length === 0,
    ...
    console.log(
      `  ✗ Error accessing parents with missing partnership: ${e.message}`,
    );
    testCount++;
  }
}
...
console.log('\nTest 8: Partners/spouses relationship');
{
  ...
  const marriage = new Partnership(
    mockService,
    'marriage',
    {},
    {
...
console.log('\nTest 9: Complex path through step-relations');
{
  ...
  const a = new Person(
    ...
    { name: 'Person A', gender: 'male' },
    {
      ...
      parentIn: {
        data: [
          { type: 'partnership', id: 'ab' },
          { type: 'partnership', id: 'ax' },
        ],
      },
    },
  );
  ...
  const x = new Person(
    ...
    {
      childIn: { data: null },
      parentIn: { data: [{ type: 'partnership', id: 'ax' }] },
    },
  );
  const y = new Person(
    mockService,
    ...
    {
      childIn: { data: null },
      parentIn: { data: [{ type: 'partnership', id: 'by' }] },
    },
  );
  const c = new Person(
    mockService,
    ...
    {
      childIn: { data: { type: 'partnership', id: 'by' } },
      parentIn: { data: [] },
    },
  );
  const d = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'ax' } },
      parentIn: { data: [] },
    },
  );

  const ab = new Partnership(
    mockService,
    'ab',
    {},
    {
  ...
  const ax = new Partnership(
    ...
    {},
    {
      ...
      children: { data: [{ type: 'person', id: 'd' }] },
    },
  );
  const by = new Partnership(
    mockService,
    'by',
    {},
    {
      ...
      children: { data: [{ type: 'person', id: 'c' }] },
    },
  );
  ...
  console.log(
    `  Found ${relationships.length} relationships between step-siblings C and D`,
  );
  assert(
    relationships.length >= 1,
    'Step-siblings through partner connection should be related',
  );
}
...
console.log('\nTest 10: Direct partner relationships (edge case for via())');
{
  ...
  const person1 = new Person(
    ...
    {
      childIn: { data: null },
      parentIn: { data: [{ type: 'partnership', id: 'direct' }] },
    },
  );
  const person2 = new Person(
    mockService,
  ...
  assert(
    relationships.length >= 1,
    'Direct partners should have a relationship',
  );
  ...
  if (relationships.length > 0) {
    assertEqual(
      relationships[0].name,
      'wife',
      'Should identify partner correctly',
    );
  }
}
...
console.log('\nTest 11: Great-grandparent relationship (deep ancestry)');
{
  ...
  const ggpPartnership = new Partnership(
    mockService,
    'ggp-p',
    {},
    {
      parents: { data: [{ type: 'person', id: 'ggp' }] },
      children: { data: [{ type: 'person', id: 'gp' }] },
    },
  );
  const gpPartnership = new Partnership(
    ...
    {},
    {
      parents: { data: [{ type: 'person', id: 'gp' }] },
      children: { data: [{ type: 'person', id: 'p' }] },
    },
  );
  const pPartnership = new Partnership(
    mockService,
    'p-p',
    {},
    {
      parents: { data: [{ type: 'person', id: 'p' }] },
      children: { data: [{ type: 'person', id: 'c' }] },
    },
  );
  ...
  assert(
    relationships.length >= 1,
    'Great-grandchild should have relationship to great-grandparent',
  );
  ...
  if (relationships.length > 0) {
    assertEqual(
      relationships[0].name,
      'great grandson',
      'Should identify great-grandchild correctly',
    );
  }
}
...
console.log('\nTest 13: Person with multiple partnerships to same person');
{
  ...
  const marriage1 = new Partnership(
    mockService,
    'marriage1',
    {},
    {
  ...
  const marriage2 = new Partnership(
    mockService,
    'marriage2',
    {},
    {
...
);
{
  ...
  const gp1 = new Person(
    mockService,
    'gp1',
    { name: 'Grandparent 1', gender: 'male' },
    {
      childIn: { data: null },
      parentIn: { data: [{ type: 'partnership', id: 'gpp' }] },
    },
  );
  const gp2 = new Person(
    mockService,
    'gp2',
  ...
  const p1 = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'gpp' } },
      parentIn: { data: [{ type: 'partnership', id: 'pp1' }] },
    },
  );
  const p2 = new Person(
    mockService,
    ...
    {
      childIn: { data: { type: 'partnership', id: 'gpp' } },
      parentIn: { data: [{ type: 'partnership', id: 'pp2' }] },
    },
  );
  ...
  const c1 = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'pp1' } },
      parentIn: { data: [] },
    },
  );
  const c2 = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'pp2' } },
      parentIn: { data: [] },
    },
  );

  const gpp = new Partnership(
    mockService,
    'gpp',
    {},
    {
  ...
  assert(
    relationships.length >= 1,
    'Cousins should have at least one relationship',
  );
...
console.log('\nTest 15: Double-related cousins (related through both parents)');
{
  ...
  // Partnerships
  const gp1Partnership = new Partnership(
    mockService,
    'gp1',
    {},
    {
      ...
      children: {
        data: [
          { type: 'person', id: 'dad' },
          { type: 'person', id: 'uncle' },
        ],
      },
    },
  );
  const gp2Partnership = new Partnership(
    mockService,
    'gp2',
    {},
    {
  ...
  const parents1 = new Partnership(
    mockService,
    'parents1',
    {},
    {
  ...
  const parents2 = new Partnership(
    mockService,
    'parents2',
    {},
    {
  ...
  const relationships = child1.relationshipsTo(child2);
  console.log(
    `  Found ${relationships.length} relationships between double cousins`,
  );
...
console.log('\nTest 16: Cousins who are also step-siblings');
{
  ...
  const stepPartnership = new Partnership(
    mockService,
    'step',
    {},
    {
  ...
  console.log(
    `  Found ${relationships.length} relationships for cousin-step-siblings`,
  );

  // Should find both cousin relationship (through moms) and step-sibling (through dads' partnership)
  assert(
    relationships.length >= 2,
    'Should find both cousin and step-sibling relationships',
  );
  ...
  const hasStepSibling = relationshipTypes.some(
    (name) => name.includes('sibling') || name === 'Child B',
  );

  assert(
    hasCousin || hasStepSibling,
    'Should identify at least one of the relationship types',
  );
}
...
console.log('\nTest 17: Complex multi-path relationships');
{
  ...
  const ggp = new Person(
    ...
    {
      childIn: { data: null },
      parentIn: { data: [{ type: 'partnership', id: 'ggpp' }] },
    },
  );
  ...
  const gp1 = new Person(
    ...
    { name: 'Grandparent 1', gender: 'male' },
    {
      childIn: { data: { type: 'partnership', id: 'ggpp' } },
      parentIn: { data: [{ type: 'partnership', id: 'gp1p' }] },
    },
  );
  const gp2 = new Person(
    mockService,
    ...
    {
      childIn: { data: { type: 'partnership', id: 'ggpp' } },
      parentIn: { data: [{ type: 'partnership', id: 'gp2p' }] },
    },
  );
  ...
  const parentA = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'gp1p' } },
      parentIn: {
        data: [
          { type: 'partnership', id: 'pa' },
          { type: 'partnership', id: 'step' },
        ],
      },
    },
  );
  const parentB1 = new Person(
    mockService,
    'parentB1',
    { name: 'Parent B1', gender: 'female' },
    {
      childIn: { data: { type: 'partnership', id: 'gp2p' } },
      parentIn: { data: [{ type: 'partnership', id: 'pb' }] },
    },
  );
  const parentB2 = new Person(
    mockService,
    'parentB2',
    { name: 'Parent B2 (sibling of B1)', gender: 'male' },
    {
      childIn: { data: { type: 'partnership', id: 'gp2p' } },
      parentIn: { data: [{ type: 'partnership', id: 'step' }] },
    },
  );
  ...
  const personA = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'pa' } },
      parentIn: { data: [] },
    },
  );
  const personB = new Person(
    ...
    {
      childIn: { data: { type: 'partnership', id: 'pb' } },
      parentIn: { data: [] },
    },
  );

  const ggpp = new Partnership(
    mockService,
    'ggpp',
    {},
    {
  ...
  const gp2p = new Partnership(
    ...
    {},
    {
      ...
      children: {
        data: [
          { type: 'person', id: 'parentB1' },
          { type: 'person', id: 'parentB2' },
        ],
      },
    },
  );
  const pa = new Partnership(
    mockService,
    'pa',
    {},
    {
  ...
  console.log(
    `  Found ${relationships.length} relationships in complex multi-path case`,
  );

  assert(
    relationships.length >= 2,
    'Should find multiple relationship paths in complex case',
  );
