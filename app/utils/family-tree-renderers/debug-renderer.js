      ...
      data: {
        renderTree: {
          ...
          persons: renderTree.persons.map((p, idx) => ({
            ...
            id: p.id,
            name: p.name,
            upFamilyRIndex: p.upFamilyRIndex,
            rightFamilyRIndices: p.rightFamilyRIndices,
          })),
          families: renderTree.families.map((f, idx) => ({
            index: idx,
            id: f.id,
            type: f.type,
            spouseRIndices: f.spouseRIndices,
            childRIndices: f.childRIndices,
